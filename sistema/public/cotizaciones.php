...
<section class="internal-topbar" aria-label="Navegación interna de cotizaciones">
  ...
  <nav class="internal-nav" aria-label="Accesos de cotizaciones">
    ...
    <a class="internal-nav-link" href="#crear-borrador">Crear borrador</a>
    <a class="internal-nav-link" href="logout.php">Cerrar sesión</a>
  </nav>
</section>

<section class="quotes-page-heading">
  <div>
...
<section class="grid quotes-summary-grid">
  <article class="card">
    <h2>Total</h2>
  ...
  <article class="card">
    <h2>Acciones</h2>
    <p>Los borradores pueden editarse y emitirse desde sus vistas autorizadas.</p>
  </article>
</section>

<section class="card quote-section quote-table-wrapper quotes-list-section">
  <div class="quotes-section-header">
    <div>
      <p class="quotes-eyebrow">Listado real</p>
      <h2>Listado de cotizaciones</h2>
    </div>
    <p class="quote-section-copy">Datos reales leídos desde la tabla cotizaciones.</p>
  </div>
  <?php if ($quotesLoadError): ?>
